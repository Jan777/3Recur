...
public class CharacterStats extends JFrame {
	...
	public CharacterStats(PC personaje) {
		...
		button.setIcon(new ImageIcon(CharacterStats.class.getResource("/img/cancel_256.png")));
		...
		button_1.setIcon(new ImageIcon(CharacterStats.class.getResource("/img/config.png")));
		...
		button_2.setIcon(new ImageIcon(CharacterStats.class.getResource("/img/config.png")));
