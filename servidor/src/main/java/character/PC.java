...
import character.statListeners.*;

public abstract class PC extends Personaje
{

	public static int[] requisitoExp={50,148,316,578,954,1468,2140,2992,4044,5318,6834,8611,10668,13026,15702,18715,22083,25822,29949};
	protected int exp;
